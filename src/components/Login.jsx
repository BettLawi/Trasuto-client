...
//       <div className="w-full md:w-1/2 flex flex-col items-center justify-center px-8 py-16 bg-white">
//         <header className="w-full flex justify-end px-4">
//           <p className="text-gray-700">Don't have an account? <a href="/signup" className="text-blue-500">Sign up</a></p>
//         </header>
...
//               <a href="/forgot-password" className="text-sm text-blue-500">Forgot password?</a>
//             </div>
//             <button type="submit" className="w-full py-2 bg-blue-500 text-white font-semibold rounded hover:bg-blue-600">Log in</button>
//             <div className="text-center mt-4">or</div>
//             <button type="button" className="w-full py-2 border border-gray-300 text-gray-700 font-semibold rounded hover:bg-gray-100">Log in with Google</button>
//           </form>
//         </div>
//       </div>
//     </div>
